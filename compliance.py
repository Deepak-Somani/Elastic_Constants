# This script is inspired from LAMMPS: Examples/ELASTIC

# This file reads in the log file generated by the script Elastic_Constants/in.elastic
...
# open logfile
with open("log_Nb.elastic", "r") as logfile:
    txt = logfile.read()
